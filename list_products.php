...
<?php
	...
	echo '<center><table border=1><thead><th>ID</th><th>Name</th><th>Description</th><th>Price</th><th>View More</th><th>Change</th><th>Delete</th></thead>';
	while($row = mysqli_fetch_assoc($result))
	{
		...
		?>
		<td><a href=<?php echo $view_more_product_path.'?item_id='.$row['id']; ?> >View More</a></td>
